	...
	$
			.getJSON(
					...
					function(WeatherResult) {
						...
						$('.DajeonHightemp')
								.append(WeatherResult.main.temp_max);
						//풍속 출력

						$('.DajeonWindspeed').append(weatherData.main.pressure);

						// 구름량 출력
						$('.DajeonClouds').append(weatherData.main.humidity)
...
<div class="container">
		<div class="weather-side">
				<div class="weather-gradient">
						<div class="date-container">
								<h2 class="nowtime"></h2>
								<span class="date-day"></span> <i class="location-icon" data-feather="map-pin"></i> <span class="location">대전,
										KR</span>
						</div>
						<div class="weather-container">
								...
								<h3 class="DajeonWindspeed">풍속:</h3>
								<h3 class="DajeonClouds">구름량:</h3>
		...
		<style>
@import
	url('https://fonts.googleapis.com/css?family=Montserrat:400,700,900&display=swap')
	;
